# Benchmark: Twenty-Four-Model Comparison (Qwen + Opus + Sonnet + DeepSeek + Step + Ornith + A1 + Ternary Bonsai + Laguna + Muse Glimmer)
...
**[Qwen 3.8-27B-4bit (unsloth), reasoning-medium](https://huggingface.co/unsloth/Qwen3.8-27B-GGUF) wins outright at 73/80.** [Qwen 3.8-27B-FP8](https://huggingface.co/Qwen/Qwen3.8-27B-FP8), Qwen 3.6-27B-Q6K (unsloth), and [DeepSeek-V4-Flash-0731 IQ3_XXS](https://huggingface.co/unsloth/DeepSeek-V4-Flash-0731-GGUF) tie for second (69/80). [Qwen 3.8-27B-FP8 (reasoning-medium)](https://huggingface.co/Qwen/Qwen3.8-27B-FP8) places 5th at 68/80. **Claude Opus 4.6 (GitHub Copilot)** ties Qwen 3.6-27B-8bit for 6th at 66.5/80 — 1.5 points above Sonnet 4.5 (65/80, 8th): same sync score as Sonnet (33/40) and 1.5 points stronger on widgets (33.5 vs 32). [Qwen 3.8-27B-4bit (unsloth), thinking off](https://huggingface.co/unsloth/Qwen3.8-27B-GGUF) places 14th at 60/80 — same GGUF file as the winner, but thinking disabled. [Muse Glimmer 30B Q4_K_XL (unsloth)](https://huggingface.co/unsloth/Muse-Glimmer-30B-GGUF) places 18th at 57/80, narrowly ahead of the official K-Quant Dynamic build (56/80, 19th).
...
| 6 (tie) | Qwen 3.6-27B-8bit (Local) | 66.5/80 |
| 6 (tie) | Claude Opus 4.6 (GitHub Copilot) | 66.5/80 |
| 8 | Claude Sonnet 4.5 | 65/80 |
| 9 | [Laguna S 2.1-NVFP4](https://huggingface.co/poolside/Laguna-S-2.1-NVFP4) | 64.5/80 |
| 10 | Qwen 3.6-35B-A3B-8bit (Local, agent-pair) | 64/80 |
| 11 | [Qwen 3.6-27B-NVFP4](https://huggingface.co/nvidia/Qwen3.6-27B-NVFP4) | 63/80 |
| 12 | [DeepSeek-V4-Flash-REAP-180B](https://huggingface.co/0xSero/DeepSeek-V4-Flash-180B) | 62/80 |
| 13 | Qwen 3.6-27B-NVFP4 (unsloth) | 61/80 |
| 14 | [Qwen 3.8-27B-4bit (unsloth), thinking off](https://huggingface.co/unsloth/Qwen3.8-27B-GGUF) | 60/80 |
| 15 (tie) | Qwen 3.6-27B-4bit | 59/80 |
| 15 (tie) | Qwen 3.6-35B-A3B-4bit | 59/80 |
| 17 | Qwen 3.6-27B-AEON-NVFP4 | 57.5/80 |
| 18 | [Muse Glimmer 30B Q4_K_XL (unsloth)](https://huggingface.co/unsloth/Muse-Glimmer-30B-GGUF) | 57/80 |
| 19 | [Muse Glimmer 30B K-Quant Dynamic](https://huggingface.co/meta-models/Muse-Glimmer-30B-GGUF/) | 56/80 |
| 20 | Qwen 3.6-27B-4bit (OpenRouter) | 54/80 |
| 21 | [Ornith-1.0-35B-8bit](https://huggingface.co/deepreinforce-ai/Ornith-1.0-35B-GGUF) | 51/80 |
| 22 | [Ternary Bonsai 27B](https://huggingface.co/prism-ml/Ternary-Bonsai-27B-gguf) | 50.5/80 |
| 23 | Agents A1 FP8 | 48/80 |
| 24 | [Step-3.7-Flash IQ4_XS](https://huggingface.co/stepfun-ai/Step-3.7-Flash-GGUF) | 46/80 |
